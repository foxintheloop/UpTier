...
// ============================================================================
export const PRIORITIZATION_STRATEGIES = {
    balanced: {
        label: 'Balanced',
        description: 'Weighs all factors equally',
        prompt_hint: 'Balance effort, impact, urgency, and importance equally. Consider goal alignment.',
    },
    urgent_first: {
        label: 'Urgent First',
        description: 'Prioritizes by deadline and urgency',
        prompt_hint: 'Focus on urgency_score and due dates. Overdue items get Tier 1. Due soon gets Tier 2.',
    },
    quick_wins: {
        label: 'Quick Wins',
        description: 'Low effort, high impact tasks first',
        prompt_hint: 'Prioritize tasks with low effort (1-2) and high impact (4-5). Great for building momentum.',
    },
    high_impact: {
        label: 'High Impact',
        description: 'Maximum impact regardless of effort',
        prompt_hint: 'Focus on impact_score above all else. High impact tasks get Tier 1 regardless of effort.',
    },
    eisenhower: {
        label: 'Eisenhower',
        description: 'Classic urgent/important matrix',
        prompt_hint: 'Use the Eisenhower matrix: Tier 1 = Important+Urgent, Tier 2 = Important+Not Urgent, Tier 3 = Not Important (consider delegating or eliminating urgent but not important tasks).',
    },
};
// ============================================================================
